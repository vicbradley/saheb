...
import EditShippingData from "./EditShippingData";
...
const Profile = ({ params }) => {
  ...
  return (
    <div className="w-[90%] max-w-md m-auto mt-8 bg-white border border-gray-200 rounded-lg shadow p-4">
      <div className="flex flex-col items-center pb-10">
        ...
        <div className="flex justify-around mt-4 md:mt-6 space-x-4">
          <EditProfile />
          <EditShippingData />
        </div>
      </div>
