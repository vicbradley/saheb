    ...
    <div className="transition-opacity duration-500">
      <form action="">
        ...
        <div className="form-control w-full max-w-xs">
          ...
          <input onChange={(e) => setStoreId(e.target.value)} type="text" placeholder="Type here" className="input input-bordered w-full max-w-xs" />
          <label className="label">
        ...
        <div className="form-control w-full max-w-xs">
          ...
          <input onChange={(e) => setStoreName(e.target.value)} type="text" placeholder="Type here" className="input input-bordered w-full max-w-xs" />
